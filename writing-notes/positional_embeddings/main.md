...
Suppose the token $T$ is located at position (\n_) in a tokenized sequence $S$. The sinusoidal positional encoding of $T$ is a vector of dimension $d$, where $d$ is the embedding dimension.
